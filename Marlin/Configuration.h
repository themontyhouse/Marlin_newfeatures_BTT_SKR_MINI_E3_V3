...
/**
 * Here are some useful links to help get your machine configured and calibrated::     https://github.com/MarlinFirmware/Configurations/branches/all
 *
...
#define STRING_CONFIG_H_AUTHOR "(Montyhouse config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Zachs V2 Printer"
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_DISTANCE_MM { 7 }
...
/**
 * Auto-leveling needs preheating Tititpher68-dev enabled preheating to compensate thermal expansions
 */
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_INIT_NOW   // Init EEPROM on first boot after a new build. tititopher68-dev enable to force reset on first boot
#endif
